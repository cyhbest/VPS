...
function install_caddy(){
	...
	curl -O https://raw.githubusercontent.com/caddyserver/caddy/v1.0.4/dist/init/linux-systemd/caddy.service
...
function install_v2ray(){
    ...
    cd /etc/v2ray/
    rm -f config.json
    wget https://raw.githubusercontent.com/cyhbest/VPS/master/config.json
    v2uuid=$(cat /proc/sys/kernel/random/uuid)
    v2uuid2=$(cat /proc/sys/kernel/random/uuid)
